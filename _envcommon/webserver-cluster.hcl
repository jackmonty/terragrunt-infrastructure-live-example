...
locals {
  ...
  base_source_url = local.env-enabled && local.web-enabled ? "git::git@github-jackmonty:jackmonty/terragrunt-infrastructure-modules-example.git//asg-elb-service" : find_in_parent_folders("empty.tf")
}
